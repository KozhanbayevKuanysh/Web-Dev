...
class Car(Vehicle):
    ...
    def __str__(self):
        return f"Car: \nbrand - {self.brand}, model - {self.model}, year - {self.year}, doors: {self.doors}"
...
class Motorcycle(Vehicle):
    ...
    def __str__(self):
        return f"Motorcycle: \nbrand - {self.brand}, model - {self.model}, year - {self.year}, engine_capacity: {self.engine_capacity}cc"